...
Versioned public downloads, site CSS consolidation and broader module
...
images now use that same fixture. A new video remains pending. Consolidate the
accepted site CSS and verify a versioned distribution package afterward.
