...
`npm run proof:garden`. Next migrate persistent browsing and monitor management
out of the popup, keeping all existing workflows reachable. Then use the same
