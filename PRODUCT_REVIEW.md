...
This pass completes the first two priorities from the latest review. Bug Garden
Store storytelling, interpretive Page Context fields, versioned public downloads,
site CSS consolidation and broader module decomposition remain pending.
...
monitor administration and Result Details owns retained Page Context. Next use the same
fixture for annotation, comparison, video, and store images. Consolidate the
...
Demo and store-image scripts use the new navigation, but published recordings
and store images have not been regenerated in this pass.
