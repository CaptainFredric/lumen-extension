...
Use it when a normal screenshot carries too much noise: sticky headers, cookie banners, chat launchers, floating ads, unfinished lazy media, or missing layout context. Start from the Chrome toolbar, clean the page, capture the view you need, check sensitive regions, and save the result with useful page context attached.
...
9. Page context JSON that keeps capture details beside the images.
...
3. `downloads`: saves capture images, focused crops, and page context JSON to the user's Downloads folder.
