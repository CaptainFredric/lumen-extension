...
Use the CI artifact from the release commit for Chrome Web Store submission. The checked-in images are review previews; always upload the exact artifact produced from the signed release commit.
